      ...
      <div className="flex items-center justify-center p-6 lg:p-10">
        <div className="w-full max-w-md space-y-6">
          ...
          <Button
            ...
            type="button"
            className="w-full h-12 bg-white border border-slate-200 text-[#0A1A2F] hover:bg-slate-50 hover:border-slate-300 transition-all duration-200 font-medium gap-3 shadow-sm"
          >
          ...
          <p className="text-xs text-slate-400 text-center leading-relaxed">
            ...
            <span className="text-[#0A1A2F] font-medium underline decoration-[#C9B37E] underline-offset-4">Términos</span>{" "}
            y la{" "}
            <span className="text-[#0A1A2F] font-medium underline decoration-[#C9B37E] underline-offset-4">Política de Privacidad</span>{" "}
