  ...
  return (
    ...
    >
      <div className="flex items-start justify-between mb-6">
        ...
        <div className={`w-9 h-9 rounded-md flex items-center justify-center ${accent ? "bg-[#031433]" : "bg-slate-50"}`}>
          <Icon className={`w-4 h-4 ${accent ? "text-[#D3A154]" : "text-[#031433]"}`} />
        </div>
      </div>
      <p className="font-display text-3xl xl:text-4xl font-light tracking-tight text-[#031433]">
        {value}
      </p>
